...
describe("Teste do componente de cadastro de tarefas", () => {
    ...
    it("deve cadastrar uma nova tarefa", () => {
        ...
        fireEvent.change(getByTestId("txt-tarefa"), { target: { value: "testar componente" } }); //simula digitacao no input
        fireEvent.click(getByTestId("btn-cadastrar")); //simula click no botao cadastrar
